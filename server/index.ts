...
function setupRequestLogging(app: express.Application) {
  app.use((req, res, next) => {
    ...
    res.on("finish", () => {
      ...
      // SECURITY: log only method/path/status/timing. Response bodies were
      // previously appended here and can carry JWTs, OTPs, phone numbers and
      // other PII into server logs — never record them.
