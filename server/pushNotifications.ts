...
const ORDER_STATUS_MESSAGES: Record<string, { title: string; body: string }> = {
  confirmed: {
    title: "تم تأكيد طلبك",
    body: "طلبك قيد التحضير الآن. سنقوم بإعلامك عند بدء التوصيل.",
  },
  preparing: {
    title: "جاري تحضير طلبك",
    body: "طلبك قيد التحضير الآن وسيكون جاهزاً للتوصيل قريباً.",
  },
  delivering: {
    title: "طلبك في الطريق",
    body: "مندوب التوصيل في طريقه إليك. يرجى التأكد من توفرك لاستلام الطلب.",
  },
  delivered: {
    title: "تم توصيل طلبك",
  ...
  cancelled: {
    title: "تم إلغاء طلبك",
    body: "نأسف لإعلامك أنه تم إلغاء طلبك. يرجى التواصل معنا للمزيد من التفاصيل.",
  },
};
