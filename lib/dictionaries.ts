...
const ar: Dictionary = {
  ...
  showcase: {
    eyebrow: "خطوات البداية",
    title: "ابدأ مع OnWay بأربع خطوات",
    subtitle: "من فتح التطبيق حتى وصول طلبك إلى بابك — رحلة بسيطة بلقطات حقيقية من التطبيق.",
    screens: [
      { title: "افتح التطبيق", caption: "حمّل OnWay وابدأ رحلتك من الضلوعية إلى باب بيتك." },
      { title: "سجّل برقم هاتفك", caption: "أنشئ حسابك برقم هاتفك فقط خلال ثوانٍ." },
      { title: "تصفّح واطلب", caption: "اختر من المتاجر والمطاعم والأقسام وأضف ما تريد." },
      { title: "تابع حتى بابك", caption: "راقب طلبك لحظة بلحظة حتى يصل إليك." },
    ],
    prev: "السابق",
    next: "التالي",
  },
...
const en: Dictionary = {
  ...
  showcase: {
    ...
    title: "Start with OnWay in four steps",
    subtitle: "From opening the app to your order reaching your door — a simple journey, shown with real app screens.",
    screens: [
      { title: "Open the app", caption: "Download OnWay and start your journey from Ḍuluʿiyya to your door." },
      { title: "Sign in with your phone", caption: "Create your account with just your phone number, in seconds." },
      { title: "Browse and order", caption: "Pick from stores, restaurants and categories, and add what you need." },
      { title: "Track to your door", caption: "Follow your order live until it reaches you." },
    ],
    prev: "Previous",
    next: "Next",
  },
