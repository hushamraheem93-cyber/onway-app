...
export default function VendorRegistrationScreen() {
  ...
  const { phoneNumber, completeVendorRegistration, goBackToUserType } =
    useAuth();
  ...
  if (success) {
    return (
      ...
      >
        <LinearGradient
          colors={[AppColors.vendorPurpleLight, AppColors.vendorPurpleLight]}
          ...
          {[
            ...
            <View key={i} style={styles.stepRow}>
              <View
                style={[
                  styles.stepNum,
                  { backgroundColor: i === 0 ? PURPLE : AppColors.gray300 },
                ]}
              >
              ...
              <MaterialCommunityIcons
                ...
                size={20}
                color={i === 0 ? PURPLE : AppColors.gray400}
                style={{ marginHorizontal: 10 }}
              />
              <ThemedText
                style={[
                  styles.stepLabel,
                  { color: i === 0 ? AppColors.gray700 : AppColors.gray400 },
                ]}
              >
                {step.label}
              </ThemedText>
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.phoneNote}>
          ...
          <ThemedText style={styles.phoneNoteText}>
...
const styles = StyleSheet.create({
  ...
  input: {
    ...
    // Give the tall Arabic glyphs vertical room so they are not clipped from the top.
    // iOS needs the explicit lineHeight; Android additionally needs font padding off.
  ...
  mapBtn: {
    ...
    gap: 8,
    borderWidth: 1.5,
    borderColor: AppColors.vendorPurple,
    borderRadius: 14,
    paddingVertical: 14,
    marginBottom: 10,
