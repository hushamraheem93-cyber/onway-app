...
.pin-dot{width:36px;height:36px;border-radius:50% 50% 50% 0;background:#FB5B21;transform:rotate(-45deg);position:absolute;border:3px solid #fff;box-shadow:0 3px 10px rgba(251,91,33,0.4);}
...
.pulse{width:50px;height:50px;border-radius:50%;background:rgba(251,91,33,0.2);position:absolute;left:-7px;top:-7px;animation:p 2s ease-out infinite;}
@keyframes p{0%{transform:scale(0.5);opacity:1;}100%{transform:scale(1.4);opacity:0;}}
.pin-tooltip{background:#FB5B21!important;color:#fff!important;border:none!important;border-radius:8px!important;padding:4px 10px!important;font-size:12px!important;font-weight:700!important;box-shadow:0 2px 8px rgba(251,91,33,0.3)!important;direction:rtl!important;white-space:nowrap!important;}
.pin-tooltip::before{border-top-color:#FB5B21!important;}
.open-btn{position:absolute;bottom:10px;left:50%;transform:translateX(-50%);background:#FB5B21;color:#fff;border:none;border-radius:20px;padding:8px 20px;font-size:13px;font-weight:700;box-shadow:0 3px 12px rgba(251,91,33,0.4);cursor:pointer;z-index:1000;display:flex;align-items:center;gap:6px;direction:rtl;font-family:'Segoe UI',Tahoma,sans-serif;}
</style>
</head><body>
<div id="map"></div>
