  ...
  <style>
    * { margin: 0; padding: 0; }
    ...
    .marker-pin {
      ...
      background: #FB5B21; transform: rotate(-45deg);
      position: absolute; left: 0; top: 0;
      box-shadow: 0 3px 10px rgba(251,91,33,0.4);
    ...
    .pulse-ring {
      ...
      background: rgba(251,91,33,0.2); position: absolute;
      left: -10px; top: -10px;
    ...
    .pin-tooltip {
      background: #FB5B21 !important; color: #fff !important;
      border: none !important; border-radius: 10px !important;
      padding: 6px 14px !important; font-size: 13px !important;
      font-weight: 700 !important; box-shadow: 0 3px 12px rgba(251,91,33,0.35) !important;
