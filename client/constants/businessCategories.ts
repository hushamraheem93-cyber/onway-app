...
export const DYNAMIC_FIELDS: Record<string, DynamicFieldConfig[]> = {
  restaurant: [
    ...
    },
    {
      ...
      label: "مستوى الحار",
      type: "select",
      options: ["غير حار", "خفيف", "متوسط", "حار", "حار جداً"],
    },
    {
      key: "sizes",
  ...
  supermarket: [
    {
      ...
      label: "الوزن / الحجم",
      type: "text",
      placeholder: "1 كيلو / 500 مل",
    },
    {
      key: "quantity",
      label: "الكمية في الباكيج",
      type: "number",
      placeholder: "12",
    },
    {
  ...
  sweets: [
    ...
    {
      key: "allowNote",
      label: "إمكانية كتابة ملاحظة أو تهنئة",
      type: "toggle",
    },
  ],
  cafe: [
    ...
    },
    {
      ...
      label: "ساخن / بارد",
      type: "select",
      options: ["ساخن", "بارد", "الاثنان"],
    },
    {
      key: "extras",
      label: "إضافات متاحة",
      type: "text",
      placeholder: "حليب نباتي، سكر إضافي...",
    },
  ],
  grocery: [],
  butcher: [
    {
      ...
      label: "نوع القطع",
      type: "text",
      placeholder: "شرائح / مكعبات / مفروم",
    },
...
export const ALL_CATEGORIES = Array.from(
  new Set(Object.values(CATEGORY_MAP).flat()),
);
